...
LogPresetsDialog::LogPresetsDialog(std::shared_ptr<CompatibilityInfoClass> compat_info,
                                   QWidget* parent)
...
void LogPresetsDialog::LoadFromSettings() {
    ...
    const auto list = m_compat_info->LoadPresets();
...
void LogPresetsDialog::SaveToSettings() {
    ...
    m_compat_info->SavePresets(list);
}
